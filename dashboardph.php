...
>
 ...
 লগআউট
            ...
            <!-- Mobile menu button -->
            <button class="mobile-menu-btn" id="historyMenuBtn">⋯</button>
        </header>
    ...
    <script>
        // Mobile history menu functionality
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (historyMenuBtn && historyContainer) {
            ...
            // Close history when clicking on edit/send/delete buttons
            document.addEventListener('click', function(e) {
                if (e.target.closest('.edit-btn, .delete-btn, .send-btn')) {
